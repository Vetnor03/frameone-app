...
test('inline editor previews snapped drags without mutating geometry and safely cancels',async()=>{
  ...
  assert.match(editor,/previewDividerStroke\(cells,\{start,end:current\}/)
  ...
  assert.match(editor,/const end=point\(e\),start=drag\.current\.start;clearDrag\(e\.pointerId\);const result=finalizeDividerStroke/)
