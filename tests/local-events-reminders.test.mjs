...
test('local event frame title removes only matching occurrence date suffix', () => {
  const rows = [
    ...
    { id: '2', user_id: 'u1', provider: 'local_events', external_id: 'edge-of-norway:2', title: 'Football festival in Vågen on 11 July – Norway v England', body: null, starts_at: '2026-07-12T17:00:00+02:00', due_at: null, priority: 8, raw: { source: 'local_events', type: 'local_event' } },
  ]
  ...
  assert.equal(items[1].title, 'Football festival in Vågen on 11 July – Norway v England')
})
