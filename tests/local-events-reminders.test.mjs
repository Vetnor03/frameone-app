...
test('local events appear as upcoming reminder items with location in title', () => {
  const items = buildLocalEventItems([
    { id: '1', user_id: 'u1', provider: 'local_events', external_id: 'friskus:1', title: 'Gladmatfestivalen · Vågen', body: null, starts_at: '2026-07-12T12:00:00+02:00', due_at: null, priority: 8, raw: { source: 'local_events', type: 'local_event' } },
...
test('local events sort after personal reminders at same time', () => {
  const local = buildLocalEventItems([
    { id: '1', user_id: 'u1', provider: 'local_events', external_id: 'friskus:1', title: 'Local', body: null, starts_at: '2026-07-12T12:00:00+02:00', due_at: null, priority: 8, raw: { source: 'local_events', type: 'local_event' } },
