...
test('custom generic wave-period buckets are continuous and lower-inclusive upper-exclusive', () => {
  ...
  assert.equal(scoreFromProfile('wave_period', 5.0), 1.5)
  assert.equal(scoreFromProfile('wave_period', 6.0), 2)
  assert.equal(scoreFromProfile('wave_period', 6.999), 2)
  assert.equal(scoreFromProfile('wave_period', 7.0), 2.5)
  assert.equal(scoreFromProfile('wave_period', 8.0), 3)
  assert.equal(scoreFromProfile('wave_period', 9.0), 4)
  assert.equal(scoreFromProfile('wave_period', 10.5), 5)
  assert.equal(scoreFromProfile('wave_period', 12.5), 6)
