...
test('Surf main wave text mirrors firmware fallback and normalization', () => {
  ...
  assert.equal(hash('surf:1', { forecast: { wave_height_range_label: '1-2m' }, picked: { wave_height_range_label: 'Hidden one' } }, cell), hash('surf:1', { forecast: { wave_height_range_label: '1-2m' }, picked: { wave_height_range_label: 'Hidden two' } }, cell))
  ...
  assert.equal(wave({ picked: { wave_height_range_label: '2-3m' } }), '2 - 3 m')
  assert.equal(wave({ forecast: { wave_height_range_label: null }, picked: { wave_height_range_label: '2-3m' } }), '2 - 3 m')
  assert.equal(wave({ forecast: { wave_height_range_label: '' }, picked: { wave_height_range_label: '2-3m' } }), '--')
  assert.equal(wave({ forecast: { wave_height_range_label: '' }, picked: { wave_height_range_label: '2-3m' }, line1: 'Clean waves' }), 'Clean waves')
  assert.notEqual(hash('surf:1', { forecast: { wave_height_range_label: '' }, picked: { wave_height_range_label: '2-3m' }, line1: 'Clean waves' }, cell), hash('surf:1', { forecast: { wave_height_range_label: '' }, picked: { wave_height_range_label: '2-3m' }, line1: 'Messy waves' }, cell))
  assert.equal(wave({ summary: 'Clean' }), 'Clean')
  assert.equal(wave({ line1: '', summary: 'Clean' }), '--')
  assert.equal(hash('surf:1', { line1: '', picked: { summary: 'Hidden one' } }, cell), hash('surf:1', { line1: '', picked: { summary: 'Hidden two' } }, cell))
