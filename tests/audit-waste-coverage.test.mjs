...
import { buildAudit, loadMunicipalities, loadRegistry, STATUSES, totals } from '../scripts/audit-waste-coverage.mjs'
...
test('audit derives registry and known cases without changing routing', () => {
  ...
  assert.deepEqual(count, { supported:7, preview:2, adapter_exists_missing_registry:20, known_provider_no_adapter:53, credential_blocked:8, auth_gated:1, unknown_provider:266 })
