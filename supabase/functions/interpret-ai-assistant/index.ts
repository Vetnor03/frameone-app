...
const invalidTopicStart = /^(?:hva|hvor|når|hvordan|skjer|finn|følg|følge|varsle|what|where|when|how|find|follow|update|news|assistant|watch|monitor|track|alert)\b/i
const invalidTopicWord = /^(?:hva|hvor|når|hvordan|skjer|finn|følg|følge|oppdatering|oppdateringer|nyheter|assistent|what|where|when|how|find|follow|update|updates|news|assistant|watch|monitor|track|alert)$/i
