...
- ESP32 Arduino lib-builder commit `6671d0bd65cdb9d4cc1001b759e8610de945a8d5`
- ESP32-S3
...
By default the verified S3 SDK is written to `.pm-production-dist/esp32s3`. Firmware CI builds the same libraries and injects that directory into the Arduino 3.3.11 S3 SDK path before compiling the real flat Alfred sketch.
