...
# This reproduces the PM-enabled Arduino-ESP32 3.3.11 / IDF 5.5.5
...
# Pin Arduino and TinyUSB instead of following dependency HEAD.
...
# Install/export the matching IDF and toolchain.
source ./tools/install-esp-idf.sh

cp "$SCRIPT_DIR/defconfig.remind_pm" configs/defconfig.remind_pm

# Build common S3 IDF libraries plus Alfred's qio_opi memory variant.
