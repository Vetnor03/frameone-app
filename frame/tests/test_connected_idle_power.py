...
def test_main_uses_ten_second_battery_connected_idle_and_deep_sleep_fallback():
    ...
    assert "connected light sleep unavailable; use 10-second deep-sleep fallback" in interactive
