...
const defaultWaitlistFormProps = {
  source: 'test-landing',
  page: '/test',
...
export default function InterestLandingPage({
  routePath = '/test',
  waitlistSource = 'test-landing',
}: InterestLandingPageProps) {
  const waitlistFormProps = {
    ...defaultWaitlistFormProps,
    ...
    >
      <header className="border-b border-black/8 bg-[#f6f3ed]/95 backdrop-blur">
        <div className="mx-auto flex w-full max-w-[1180px] min-w-0 items-center justify-between gap-3 px-5 py-5 md:px-10">
          <a href={routePath} className="min-w-0 text-[24px] font-medium tracking-[0.28em] text-black/90 md:text-[29px]">
            RE:MIND
          </a>
          <a
            href="#early-access"
      ...
      <section className="w-full max-w-full px-5 pb-5 pt-5 md:px-10 md:pb-10 md:pt-12">
        <div className="mx-auto grid w-full max-w-[1180px] min-w-0 gap-6 lg:grid-cols-[minmax(0,1.02fr)_minmax(360px,0.98fr)] lg:items-center lg:gap-12">
          <ShopReveal className="min-w-0 w-full max-w-full">
            <div className="flex w-full max-w-full min-w-0 flex-col gap-4 md:gap-5">
              <div>
          ...
          <ShopReveal delayMs={80} className="min-w-0 w-full max-w-full">
            <div className="relative w-full max-w-full overflow-hidden rounded-[34px] border border-black/10 bg-[#eee7dc] shadow-[0_30px_80px_rgba(73,54,34,0.18)]">
              ...
              <div className="absolute bottom-4 left-4 right-4 max-w-[calc(100%-2rem)] rounded-[22px] border border-white/45 bg-white/75 p-4 shadow-[0_18px_40px_rgba(0,0,0,0.10)] backdrop-blur md:bottom-6 md:left-6 md:right-auto md:max-w-[315px]">
      ...
      <section className="w-full max-w-full px-5 pb-6 pt-3 md:px-10 md:pb-10 md:pt-4" aria-labelledby="founder-note">
        <ShopReveal className="min-w-0 w-full max-w-full">
          <div className="mx-auto w-full max-w-[1180px] rounded-[32px] border border-black/10 bg-[#fffdf9] p-5 shadow-[0_24px_70px_rgba(73,54,34,0.10)] sm:p-7 md:p-10">
      ...
      <section className="w-full max-w-full px-5 pb-8 pt-2 md:px-10 md:pb-12 md:pt-6" aria-labelledby="test-benefits">
