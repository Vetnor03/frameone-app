export const STUDIO_MODULES = ['date','reminders','weather','countdown','surf','soccer','stocks','groceries','assistant']
...
export function studioRenderStrategy(module, colSpan, rowSpan, width, height) {
  ...
  if (module === 'assistant') return { path:'ai-follow-responsive', legacyVariant:null, profile }
