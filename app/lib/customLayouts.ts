import {
  ...
  ADAPTIVE_PHYSICAL_GEOMETRIES as adaptiveGeometries,
  ...
  supportsPhysicalCustomCell as supportsCell, supportsPhysicalCustomLayout as supportsLayout,
...
export const ADAPTIVE_PHYSICAL_GEOMETRIES = adaptiveGeometries as Set<string>
...
export const supportsPhysicalCustomLayout = supportsLayout as (cells:unknown)=>{valid:boolean;errors:string[];unsupportedSlots:number[]}
