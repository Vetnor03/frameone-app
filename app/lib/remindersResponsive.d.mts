...
export type ReminderComposition={available:boolean;direction:'horizontal'|'vertical';showHeading:boolean;showTime:boolean;showTomorrow:boolean;todayItems:number;tomorrowItems:number;maxItems:number;overflow:number}
export type ReminderItemLayout={itemRect:ReminderRect;timeRect:ReminderRect;titleRect:ReminderRect;stacked:boolean}
export type ReminderLayout={pad:number;emptyRect:ReminderRect|null;todayRect:ReminderRect|null;tomorrowRect:ReminderRect|null;footerRect:ReminderRect|null;items:readonly ReminderItemLayout[]}
