...
export default function FrameAssistant({ deviceId, language, tipsEnabled, tipsShown, onTipShown, onNavigate }: { deviceId: string | null; language: 'en' | 'no'; tipsEnabled: boolean; tipsShown: number[]; onTipShown: (index: number) => void; onNavigate: (destination: AssistantDestination) => void }) {
  ...
  const [sessionTip] = useState(() => nextAssistantTip(tipsShown, language))
