...
const nb: Record<string, string> = {
  ...
  'Enter code': 'Skriv inn kode', 'APPLY': 'BRUK', 'Subtotal': 'Delsum', 'Discount': 'Rabatt',
  ...
  'Changed your mind? You have 30 days to return your order.': 'Ombestemt deg? Du har 30 dager på å returnere bestillingen.',
  ...
  'Built to stay.': 'Laget for å vare.', "What's covered": 'Dette dekker garantien', "What's not covered": 'Dette dekkes ikke', 'Battery replacement': 'Bytte av batteri', 'Your consumer rights': 'Rettighetene dine', 'Need help?': 'Trenger du hjelp?',
