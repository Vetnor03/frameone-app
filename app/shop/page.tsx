    ...
    >
      <div className="mx-auto w-full max-w-6xl px-6 py-8 sm:px-10 sm:py-10 lg:py-12">
        <header className="flex items-start justify-between gap-4">
          <span className="pt-1 text-sm font-semibold tracking-[0.2em]">RE:MIND</span>
          ...
          <div className="flex items-center gap-3 text-sm">
            <Link href="/login?next=/?nosplash=1" className="rounded-full border border-black/15 px-4 py-1.5 font-medium">
              Open app
            </Link>
        ...
        <nav className="mt-5 flex items-center gap-4 overflow-x-auto border-t border-black/10 pt-3 text-xs tracking-[0.08em] text-black/58 md:hidden">
          <a href="#frames" className="whitespace-nowrap">Frames</a>
          <a href="#mattes" className="whitespace-nowrap">Mattes</a>
          <a href="#accessories" className="whitespace-nowrap">Accessories</a>
        ...
        <section className="grid gap-12 py-16 md:grid-cols-[1fr_1.18fr] md:items-center md:gap-10 md:py-24 lg:gap-16 lg:py-28">
          <div className="space-y-7">
            ...
            <h1 className="max-w-xl text-[2.45rem] font-semibold leading-[1.05] tracking-[-0.02em] sm:text-[3.5rem] lg:text-[4rem]">Frames that belong in your home.</h1>
        ...
        <section id="frames" className="py-16 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {frameFinishes.map((item) => (
              <article key={item.name} className="group rounded-3xl border border-black/8 bg-[#fcfbf8] p-4 shadow-[0_10px_24px_rgba(0,0,0,0.06)] transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(0,0,0,0.09)]">
        ...
        <section id="mattes" className="py-12 sm:py-14">
          ...
          <p className="mt-3 max-w-2xl text-[1.02rem] leading-relaxed text-black/60">Swappable mattes let your frame adapt to seasons, rooms, and routines in seconds.</p>
        ...
        <section id="accessories" className="py-12 sm:py-14">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {accessories.map((item) => (
              <article key={item} className="rounded-2xl border border-black/6 bg-white p-5 shadow-[0_8px_18px_rgba(0,0,0,0.04)]"><p className="text-sm font-medium">{item}</p></article>
            ))}
          </div>
        </section>
        <footer id="about" className="mt-10 border-t border-black/10 py-12 sm:py-14">
          <p className="max-w-3xl text-[1.2rem] leading-relaxed text-black/72 sm:text-[1.28rem]">Less screen time. A final glance before leaving home. Calm information for your space.</p>
          <div className="mt-7 flex flex-wrap gap-5 text-sm text-black/50"><span>Privacy</span><span>Terms</span><span>Contact</span><span>Shipping</span></div>
        </footer>
      </div>
    </main>
  )
