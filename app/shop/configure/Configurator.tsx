...
const configuratorCopy = {
  ...
  no: {
    ...
    title: 'TILPASS DIN RE:MIND',
    subtitle: 'Velg ramme og innlegg som passer stilen og hjemmet ditt.',
    display: 'VISNING',
    ...
    storyEyebrow: '',
    storyTitle: 'SKAPT FOR HJEMMET. ENKEL Å TILPASSE.',
    ...
    storyDetails: [
      ...
      ['LANG BATTERITID', 'Laget for å stå på en hylle, et bord eller henge på veggen – uten fast kabel eller behov for et strømuttak i nærheten.'],
